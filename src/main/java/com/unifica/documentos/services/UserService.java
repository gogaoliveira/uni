...
import com.unifica.documentos.services.exceptions.AuthorizationException;
...
public class UserService {
	...
	public User fromDto(UserNewDTO userDto) {
		return new User(null, userDto.getName(), null, userDto.getCpf(), userDto.getEmail(), userDto.getPassword());
	}
